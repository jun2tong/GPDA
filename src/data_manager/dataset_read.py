...
from src.data_manager.svhn import load_svhn
from src.data_manager.mnist import load_mnist, load_mnist_new
...
def dataset_read(source, target, batch_size, scale=False, all_use='no'):
    ...
    train_loader = UnalignedDataLoader(S, T, batch_size, batch_size, scale=scale)
    ...
    test_loader = UnalignedDataLoader(S_test, T_test, batch_size, batch_size, scale=scale)
