...
Deep learning for visual task has achieved super human performance under the assumption that the training and testing data are generated independently and identically from a distribution (i.i.d). 
However, this assumption is often costly to satisfy as nicely labelled data is difficult to come by.
...
An example might be the training of a text sentiment analysis system to classify email from clients to lawyers as either satisfied or unsatisfied. 
